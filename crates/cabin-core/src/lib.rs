...
pub use model::{
    ...
    SystemDependency, Target, TargetDep, TargetKind, TargetName, WorkspaceDepRequirements,
    is_path_safe_package_name, is_valid_package_scope, validate_links_identity,
};
pub use patch::{
