...
- an optional `[package.upstream]` table, when present, already passed the manifest parser's
  provenance rules (credential-free HTTPS URL, `sha256:`-prefixed 64-hex `checksum`, `"tar.gz"` /
  `"zip"` format,
