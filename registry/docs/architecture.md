...
The GitHub access token is used for the single `/user` read and
dropped - never persisted, never logged. The read plane itself is public for verified content ("Origins
